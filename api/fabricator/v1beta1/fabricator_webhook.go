...
// +kubebuilder:webhook:path=/mutate-fabricator-githedgehog-com-v1beta1-fabricator,mutating=true,failurePolicy=fail,sideEffects=None,groups=fabricator.githedgehog.com,resources=fabricators,verbs=create;update,versions=v1beta1,name=mfabricator.kb.io,admissionReviewVersions=v1
...
// +kubebuilder:webhook:path=/validate-fabricator-githedgehog-com-v1beta1-fabricator,mutating=false,failurePolicy=fail,sideEffects=None,groups=fabricator.githedgehog.com,resources=fabricators,verbs=create;update,versions=v1beta1,name=vfabricator.kb.io,admissionReviewVersions=v1

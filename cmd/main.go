...
func main() {
	...
	if err = (&fabricatorcontroller.FabricatorReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "Fabricator")
		os.Exit(1)
	}
	...
	if err = (&fabricatorcontroller.ControlNodeReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "ControlNode")
		os.Exit(1)
	}
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {

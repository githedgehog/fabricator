...
The mapping of lab environments to switch profiles is maintained in the internal
[`githedgehog/lab`](https://github.com/githedgehog/lab/blob/master/docs/testing/testing-infrastructure.md)
repository.
...
See the internal [Test Gaps and Roadmap](https://github.com/githedgehog/lab/blob/master/docs/testing/testing-gaps-and-roadmap.md)
for the proposed tiered test strategy.

...
- **`hlab` runner**: Machines connected to physical switches running SONiC on real ASICs.
  Wiring loaded from `lab-ci/envs/$KUBE_NODE/`. See the internal `githedgehog/lab` repo

...
replace github.com/diskfs/go-diskfs v1.4.1 => github.com/Frostman/go-diskfs v1.4.1-hh4
...
require (
	...
	github.com/k3s-io/helm-controller v0.16.2
	...
	go.githedgehog.com/fabric v0.44.0

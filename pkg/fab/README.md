...
```bash
export FLATCAR_VERSION="v4152.2.2"
...
```bash
export CLS_SONIC_VERSION="v4.0.0"

oras push ghcr.io/githedgehog/sonic-cls-private/sonic-cls-broadcom:${CLS_SONIC_VERSION} sonic-broadcom.bin

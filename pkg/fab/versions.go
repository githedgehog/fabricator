...
var (
	...
	FabricVersion     = meta.Version("v0.95.0")
	GatewayVersion    = meta.Version("v0.27.0")
	DataplaneVersion  = meta.Version("x86_64-unknown-linux-gnu.release.e09642642598c5f4883c55ebd5e01bda1e105aae")

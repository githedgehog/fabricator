...
var (
	...
	FabricVersion     = meta.Version("v0.103.1")
	GatewayVersion    = meta.Version("v0.38.0")
	DataplaneVersion  = meta.Version("v0.10.0")
	FRRVersion        = meta.Version("v0.5.0")

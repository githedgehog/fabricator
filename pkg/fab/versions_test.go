...
func TestFabricatorCtrlUpgradeConstraint(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{"dev", "v0.50.0", true},
		{"26.03", "v0.49.3", true},
		{"26.03.0", "v0.49.3", true},
		{"26.02", "v0.47.5", false},
		{"26.02.0", "v0.47.5", false},
		{"26.01", "v0.45.5", false},
		{"26.01.0", "v0.45.5", false},
		{"25.05", "v0.43.1", false},
		{"25.04", "v0.41.3", false},
...
func TestFabricAgentUpgradeConstraint(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{"dev", "v0.130.0", true},
		{"26.03", "v0.129.4", true},
		{"26.03.0", "v0.129.4", true},
		{"26.02", "v0.120.4", false},
		{"26.02.0", "v0.120.4", false},
		{"26.01", "v0.115.4", false},
		{"26.01.0", "v0.115.4", false},
		{"25.05", "v0.96.2", false},
		{"25.04", "v0.87.4", false},
...
func TestFabricNOSUpgradeConstraint(t *testing.T) {
	...
	for _, test := range []struct {
		...
		{"26.03.0", "v4.5.2", true},
		{"26.02", "v4.5.0", false},
		{"26.02.0", "v4.5.0", false},
		{"26.01", "v4.5.0", false},
		{"26.01.0", "v4.5.0", false},
		{"25.03", "v4.5.0", false},
		{"25.03.0", "v4.5.0", false},
		{"25.02", "v4.4.2", false},
		{"25.02.0", "v4.4.2", false},
		{"25.01", "v4.4.2", false},
		{"25.01.0", "v4.4.2", false},
		{"24.09", "v4.4.0", false},
		{"dev-agent", CleanupFabricNOSVersion("4.5.3-Enterprise_Base"), true},
		{"26.03-agent", CleanupFabricNOSVersion("4.5.2-Enterprise_Base"), true},
		{"26.03.0-agent", CleanupFabricNOSVersion("4.5.2-Enterprise_Base"), true},
		{"26.02-agent", CleanupFabricNOSVersion("4.5.0-Enterprise_Base"), false},
		{"26.02.0-agent", CleanupFabricNOSVersion("4.5.0-Enterprise_Base"), false},
		{"26.01-agent", CleanupFabricNOSVersion("4.5.0-Enterprise_Base"), false},
		{"26.01.0-agent", CleanupFabricNOSVersion("4.5.0-Enterprise_Base"), false},
		{"25.03-agent", CleanupFabricNOSVersion("4.5.0-Enterprise_Base"), false},
		{"25.03.0-agent", CleanupFabricNOSVersion("4.5.0-Enterprise_Base"), false},
